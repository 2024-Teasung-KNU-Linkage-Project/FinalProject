package com.OdorPreventSystem.domain.trackingByCar.controller;


import com.OdorPreventSystem.domain.trackingByCar.service.arims.arimsService;
...
public class arimsRestController {
 ...
 @GetMapping("/arimsRealtimeCar")
  ...
  public Map<String, Object> getCarCsvContent(
    ...
    map.put("list", service.getCarCsvContent(fileName));
    return map;
  }
  ...
  public Map<String, Object> getPlaceCsvContent(
    ...
    Map<String, Object> map = new HashMap<String, Object>();
    map.put("list", service.getPlaceCsvContent(fileName));
    return map;
  }
